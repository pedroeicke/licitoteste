  ...
  return (
    <div className="overflow-hidden">
      ...
      <section id="home" className="relative min-h-[100dvh] flex items-center pt-20 pb-8 md:pb-0 px-6 bg-slate-50 overflow-hidden">
            ...
            <div className="relative transform rotate-y-[-5deg] rotate-x-[5deg] hover:rotate-0 transition-transform duration-700 ease-out preserve-3d">
              ...
              >
                <div className="w-7 h-7 md:w-10 md:h-10 bg-gradient-to-br from-green-400 to-emerald-600 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-green-500/30">
                  ...
                  <ShieldCheck size={20} className="text-white hidden md:block" />
                </div>
                <div>
                  <div className="font-bold text-dark-blue text-[11px] md:text-sm">Base Jurídica</div>
                  <div className="text-[9px] md:text-xs text-primary-cyan font-semibold">Atualizada 2025</div>
                </div>
              </motion.div>
            </div>
          </motion.div>
        ...
        <div className="absolute bottom-16 md:bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce text-slate-300">
          <ChevronDown />
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 relative">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative z-10">
            ...
            <div className="group glass-card p-6 md:p-8 rounded-3xl hover:-translate-y-2 transition-all duration-300 neon-hover">
              ...
              <h3 className="text-xl font-bold text-dark-blue mb-3">Gerador de Documentos</h3>
            ...
            <div className="group glass-card p-6 md:p-8 rounded-3xl hover:-translate-y-2 transition-all duration-300 neon-hover relative overflow-hidden">
              ...
              <h3 className="text-xl font-bold text-dark-blue mb-3">IA Customizável</h3>
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
            ...
            <div className="group glass-card p-6 md:p-8 rounded-3xl hover:-translate-y-2 transition-all duration-300 neon-hover">
              ...
              <h3 className="text-xl font-bold text-dark-blue mb-3">Módulo Consultoria</h3>
              <p className="text-slate-600 text-sm leading-relaxed mb-6">
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[auto_auto] gap-x-8 gap-y-4 mb-8 -ml-2">
                {[
            ...
            <div className="relative transform hover:scale-[1.02] transition-transform duration-500">
              ...
              {/* Badge */}
              <div className="absolute -left-4 md:-left-6 bottom-6 md:bottom-10 bg-white p-2 md:p-3 rounded-lg md:rounded-xl shadow-lg border border-slate-100 flex items-center gap-2 md:gap-3 animate-bounce-slow z-20">
                <div className="bg-primary-cyan/10 p-1.5 md:p-2 rounded-md md:rounded-lg">
                  <CheckCircle className="text-primary-cyan w-4 h-4 md:w-5 md:h-5" />
                </div>
                <div>
                  <div className="text-[10px] md:text-xs font-bold text-dark-blue">Lei 14.133</div>
                  <div className="text-[8px] md:text-[10px] text-slate-500">Compliance Automático</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="order-2 md:order-1 relative">
            ...
            <MockupWindow className="relative z-10 shadow-2xl border-slate-200/60 md:h-auto">
              <div className="relative w-full h-full aspect-[1920/950] bg-slate-900 overflow-hidden">
                <video
                  ref={customVideoRef}
                  className="w-full h-full object-cover object-center md:object-bottom scale-[1.01]"
                  autoPlay
                  loop
                  muted
                  playsInline
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-dark-blue text-lg">Contato</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-dark-blue text-lg">E-mail</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-dark-blue text-lg">Escritório</h4>
            ...
            <div className="bg-slate-50 p-6 md:p-10 rounded-3xl shadow-lg border border-slate-100 relative overflow-hidden">
              ...
              <h3 className="text-2xl font-bold mb-6 text-dark-blue relative z-10">Agende sua Demonstração</h3>
              <form className="space-y-4 relative z-10">
                ...
                <button type="button" className="w-full bg-gradient-primary text-dark-blue font-bold py-4 rounded-full shadow-lg hover:shadow-cyan-400/30 transition-all hover:scale-[1.02] transform">
                  Enviar Solicitação
                </button>
              </form>
            </div>
